...
echo ""
echo "下一步:"
echo "  1. 暴露服务: kubectl port-forward svc/ai-factory-server 8080:80 -n ${NAMESPACE}"
echo "  2. 配置 GitHub webhook: http://your-vm-ip:8080/webhook/github"
echo "  3. 给 issue 打标签触发: ai-factory-run 或 ai-factory-smoke"
